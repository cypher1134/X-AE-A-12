...
accuracy_full_train = accuracy_score(predicted_full_train_df["fake_value"], pd.read_csv("../data/train.csv",nrows=data.n)["fake_value"])
print(f"Accuracy on full training data: {accuracy_full_train * 100:.2f}%")

# Load the full training dataset
full_train_df = pd.read_csv("../data/train.csv",nrows=data.n)
